# WhatsAtende
Projeto Baseado em alguns outros porjetos aqui do Git:

https://github.com/billbarsch/myzap (Responsável pelo Index e pelo Session que se comunica com o Venom)
https://github.com/orkestral/venom (Vanom-bot Controla o WhatsApp Web)
https://github.com/googleapis/nodejs-dialogflow (Api do Dialogflow para responder as msgs)

5% - é meu projeto que une os três projetos acima e cria um bot de auto atendimento com funções de resposta automatica, redirecionamento de msg não compreendidas, mídas, anexos e etc.
...
## Setup (apenas para linux, windows não precisa)
...
`git clone https://github.com/karlosgaldino/whatsatende.git`
